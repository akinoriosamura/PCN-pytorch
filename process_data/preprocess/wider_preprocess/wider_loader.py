    ...
    def next(self):
        for event_idx, event in enumerate(self.event_list):
            ...
            for file, bbx, pose in zip(self.file_list[event_idx][0],
                ...
                # add bboxes label but pose = 0 only(o = vertical)
                bboxes = []
                bbx0 = bbx[0]
                pose0 = pose[0]
